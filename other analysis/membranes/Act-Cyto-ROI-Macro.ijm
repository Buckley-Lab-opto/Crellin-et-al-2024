// Macro to measure intensities of activated cytoplasm ROIs from ROI manager and save results in tidy format
...
for (slice=25; slice<38; slice++) { 
	setSlice(slice);
	setMetadata("Label", ""+embryo_id+"_t="+slice);
	roiManager("Measure");
}

results_folder = "/Users/helena/Library/CloudStorage/OneDrive-UniversityofCambridge/PIV-Analysis/other analysis/membranes/results/act_cyto/";
...
results_folder = "/Users/helena/Library/CloudStorage/OneDrive-UniversityofCambridge/PIV-Analysis/other analysis/membranes/results/bg_subtracted/act_cyto/";
saveAs("Results", results_folder + embryo_id + ".csv");
