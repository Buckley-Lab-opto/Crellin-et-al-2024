...
//roiManager("Deselect");
//roiManager("Delete");
//open(path + "membrane-grad.zip");

roiManager("Open", path + "membrane-grad.zip");
...
results_folder = "/Users/helena/Library/CloudStorage/OneDrive-UniversityofCambridge/PIV-Analysis/other analysis/membranes/results/mcherry/";
