...
angles_wm_by_position %>% 
  ...
  theme(axis.title.x = element_blank(),
        ...
        axis.text.y = element_blank(),  
        axis.ticks.y = element_blank()) +
  labs(title = "Average vector direction in the north region, 45s before activation") 
...
angles_wm_by_position %>% 
  ...
  theme(axis.title.x = element_blank(),
        ...
        axis.text.y = element_blank(),  
        axis.ticks.y = element_blank()) +
  labs(title = "Average vector direction in the north region, 45s after deactivation") 
